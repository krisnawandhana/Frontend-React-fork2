            ...
            <div className="flex flex-col md:w-full md:mb-6 items-center text-center lg:w-1/2 pt-20">
                ...
                <div className="w-2/4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div>
                            <label htmlFor="password" className="text-body1 font-medium text-dark-1 flex text-start">
                                Password
                            </label>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between">
                        <div className="w-full lg:w-1/2 mb-2 lg:mb-0">
                            <button type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
