...
const AddStoryForm = () => {
  return (
    <form action="#" className="space-y-4 flex flex-wrap justify-between bg-[#08B6D5] rounded-3xl p-4">
      ...
      <div className="flex flex-col w-2/3 space-y-4 bg-white p-2 rounded-xl">
        <div className="flex flex-col">
            <input type="text" id="judul" name="judul" className="p-2 rounded border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500" placeholder="Masukkan judul cerita"/>
        </div>

        <div className="flex flex-col">
            <input type="large-text" id="penyanyi" name="penyanyi" className="p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 w-full h-40" placeholder="Masukkan cerita inspiratif"/>
        </div>
